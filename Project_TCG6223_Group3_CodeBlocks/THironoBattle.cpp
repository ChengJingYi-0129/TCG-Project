...
{
    // Update skill timers, battle timers and player movement every frame.
...
{
    // Handle menu, movement and skill controls.
    switch (key)
    {
        case 13:
        case ' ':
...
{
    // Draw the arena, both characters and active skill effects.
