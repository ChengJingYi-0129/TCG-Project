...
{
 if (myvirtualworld.handleKeyDown(key))
 {
    glutPostRedisplay();
    return;
 }
 ...
 switch (key)
 {
    ...
    case '=':
        viewer.eyeY *= 0.92;
        viewer.eyeZ *= 0.92;
        if (viewer.eyeZ < 18.0) viewer.eyeZ = 18.0;
        if (viewer.eyeY < 5.0) viewer.eyeY = 5.0;
        myViewingInit();
        glutPostRedisplay();
        return;
    case '-':
    case '_':
        viewer.eyeY *= 1.08;
        viewer.eyeZ *= 1.08;
        if (viewer.eyeZ > 140.0) viewer.eyeZ = 140.0;
        if (viewer.eyeY > 50.0) viewer.eyeY = 50.0;
        myViewingInit();
        glutPostRedisplay();
        return;
    case 'r': case 'R': myDataInit(); myViewingInit(); glutPostRedisplay(); return;
...
{
 if (myvirtualworld.handleSpecialKey(key))
 {
    glutPostRedisplay();
    return;
 }
...
void myWelcome()
{
 ...
 cout << "*****************************************************************\n";
 cout << "| Press:                                                        |\n";
 cout << "|   <ENTER>                  => next page / confirm            |\n";
 cout << "|   <b>                      => back page                      |\n";
 cout << "|   <r>                      => reset camera view              |\n";
 cout << "|   <a>,<d>,<w>,<s>          => select / move character        |\n";
 ...
 cout << "|                                                               |\n";
 cout << "| Mouse wheel => zoom in / out, Left/Right Drag => rotate world |\n";
 cout << "|                                                               |\n";
 cout << "*****************************************************************\n";
 cout << "|                      H A V E   F U N  !!!                     |\n";
 cout << "*****************************************************************\n";
